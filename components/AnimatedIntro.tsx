...
const content = [
  {
    title: "Creemos",
    backgroundColor: "#E6D0F7", // Lightest color
    fontColor: Colors.pink,
  },
  {
    title: "Sugerencias",
    backgroundColor: "#C5A8E6", // Slightly darker shade
    fontColor: Colors.sky,
  },
  {
    title: "Descubramos",
    backgroundColor: "#A87FD6", // Medium-dark shade
    fontColor: Colors.blue,
  },
  {
    title: "Vamos",
    backgroundColor: "#8256C6", // Darker shade
    fontColor: Colors.yellow,
  },
  {
    title: "PAC AI",
    backgroundColor: "#3A0088", // Final darkest color
    fontColor: Colors.pink,
  },
];
  ...
  const mask = useAnimatedStyle(
    () => ({
      backgroundColor: interpolateColor(
        currentX.value,
        [half, half + labelWidth.value / 2],
        [content[newColorIndex.value].backgroundColor, content[currentIndex.value].backgroundColor],
        'RGB'
      ),
      transform: [{ translateX: currentX.value }],
      width: width / 1.5,
